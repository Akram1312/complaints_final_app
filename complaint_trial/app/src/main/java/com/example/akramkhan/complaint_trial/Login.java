...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*on submission based on the user_type logged in we call either the
        * mainactivity or wardem_main activity and also pass the usertype along with the intent*/
