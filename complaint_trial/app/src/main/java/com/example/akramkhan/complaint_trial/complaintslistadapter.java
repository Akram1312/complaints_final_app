...
public class complaintslistadapter extends BaseAdapter {
    ...
    /*custom adapter which inflates the item_list xml file with the elements of the type
    * complaint*/
    ...
    //getting a complaint at a position
    @Override
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //this sets the color based on the colorcode which is based on the status of the complaint
