            ...
            public void onClick(View v) {
                if(!sharedPreferences.contains(""+userid+"-"+cmpDid.getText().toString())){
                    ...
                    StringRequest stringRequest1 = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                        ...
                        @Override
                        public void onErrorResponse(VolleyError volleyError) {
                            Toast.makeText(complaintdetails.this, "upvote volley error", Toast.LENGTH_SHORT).show();
                        }
                    });
                    RequestQueue requestQueue1 = Volley.newRequestQueue(getApplicationContext());
                    requestQueue1.add(stringRequest1);
                    ...
                    final SharedPreferences.Editor editor = sharedPreferences.edit();
                    String url = Constants.IP+"/my_api/complaints/upvote?complaint_id="+cmpDid.getText().toString()+"&code="+sharedPreferences.getString(userid+"-"+cmpDid.getText().toString(),null);
                    editor.putString(""+userid+"-"+cmpDid.getText().toString(),"10");
                    editor.commit();
                    StringRequest stringRequest1 = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                        @Override
