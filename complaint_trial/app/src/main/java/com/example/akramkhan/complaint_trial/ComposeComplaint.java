...
public class ComposeComplaint extends AppCompatActivity {
    private EditText cmpCtitle; //complaint title
    private EditText cmpCdesc;  //complaint description
    private Button cmpsubmit;   //submit button
    private Button takephoto;   //upload a photo
    private RadioGroup type;    //type of complaint hostel,insti,personal
    private ImageView mImageView;
    private Spinner Hostel;     //selecting the hostel
    private Spinner auth;       //selecting the authority who is to be notified regarding the complaints

    private Bitmap bitmap;      //the image uploaded is converted to bitmap and the image uploaded
                                //reponses is a bitmap which converted to image
...
//                    final ProgressDialog loading = ProgressDialog.show(getApplication(), "Uploading...", "Please wait...", false, false);
        ...
        //array adapter for the drop down menu for hostel selection
...
/*    public void captureImage() {
    ...
    /*when intent with get_action is called then access the gallery and
    * convert the selected image into bitmap and upload it*/
    @Override
...
/*    private static File getOutputMediaFile(int type) {
    ...
    //method to convert the image to string
    ...
    //prompt the file chooser option
